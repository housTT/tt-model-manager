...
| `card.evaluations` | optional Markdown (accuracy/task scores with subsets, recipes and caveats) rendered under `## Evaluations`, after the serve profiles and before the performance section. |
